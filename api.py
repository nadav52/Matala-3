...
def predict():
    ...
    # Dummy values for missing columns
    Age = 0  # or some default value
    Age_Hand_interaction = 0  # or some default value
    Model_Manufactor = "unknown"  # or some default value
    ...
    input_data = pd.DataFrame({
        ...
        'Km': [float(Km)],
        'Age': [Age],
        'Age_Hand_interaction': [Age_Hand_interaction],
        'Model_Manufactor': [Model_Manufactor],
